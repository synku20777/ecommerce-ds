// ds-table-cell - Light DOM data holder for ds-table body cells.
...
export class DSTableCell extends HTMLElement {
...
customElements.define('ds-table-cell', DSTableCell);
